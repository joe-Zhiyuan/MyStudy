 ...
 */
        ...
        var N = "data-server-rendered", F = ["component", "directive", "filter"],
        ...
        var Ct = Object.getOwnPropertyNames(wt), $t = !0;
        ...
        function Pt(t, e, n) {
            if ("function" == typeof e && (e = e.options), function (t, e) {
                    ...
                    if (n) {
                        var r, o, i = {};
                        if (Array.isArray(n)) for (r = n.length; r--;) "string" == typeof(o = n[r]) && (i[$(o)] = {type: null}); else if (l(n)) for (var a in n) o = n[a], i[$(a)] = l(o) ? o : {type: o};
                        t.props = i
                    }
                }(e), function (t, e) {
                    var n = t.inject;
        ...
        function je(t) {
            t._o = Ae, t._n = h, t._s = v, t._l = ye, t._t = ge, t._q = L, t._i = M, t._m = $e, t._f = _e, t._k = we, t._b = Ce, t._v = gt, t._e = yt, t._u = Se, t._g = ke, t._d = Te, t._p = Ee
        }
            ...
            if (!o(t)) {
                ...
                if (c(t) && (t = l.extend(t)), "function" == typeof t) {
                    ...
                    if (a(t.options.functional)) return function (t, e, n, o, a) {
                        ...
                        if (i(u)) for (var l in u) c[l] = Ft(l, u, e || r); else i(n.attrs) && Le(c, n.attrs), i(n.props) && Le(c, n.props);
                        var f = new Ie(n, c, a, o, t), d = s.render.call(null, f._c, f);
                        if (d instanceof ht) return De(d, n, f.parent, s);
                        if (Array.isArray(d)) {
                            for (var p = ue(d) || [], v = new Array(p.length), h = 0; h < p.length; h++) v[h] = De(p[h], n, f.parent, s);
                            return v
                        }
                    }(t, d, e, n, s);
                    var v = e.on;
        ...
        !function (t) {
            t.prototype._init = function (t) {
                ...
                }(e, t) : e.$options = Pt(An(e.constructor), t || {}, e), e._renderProxy = e, e._self = e, function (t) {
        ...
        }), Object.defineProperty(xn, "FunctionalRenderContext", {value: Ie}), xn.version = "2.6.10";
        var Dn = m("style,class"), Ln = m("input,textarea,option,select,progress"),
            Mn = m("contenteditable,draggable,spellcheck"), Pn = m("events,caret,typing,plaintext-only"),
            Nn = function (t, e) {
                return Hn(e) || "false" === e ? "false" : "contenteditable" === t && Pn(e) ? e : "true"
            },
        ...
        function pr(t, e) {
            ...
            if (!(i(n) && !1 === n.Ctor.options.inheritAttrs || o(t.data.attrs) && o(e.data.attrs))) {
                ...
                for (r in(J || Q) && u.value !== c.value && vr(s, "value", u.value), c) o(u[r]) && (Un(r) ? s.removeAttributeNS(Rn, Vn(r)) : Mn(r) || s.removeAttribute(r))
            }
        }
        ...
        var Mr, Pr = /^--/, Nr = /\s*!important$/, Fr = function (t, e, n) {
            if (Pr.test(e)) t.style.setProperty(e, n); else if (Nr.test(n)) t.style.setProperty(O(e), n.replace(Nr, ""), "important"); else {
                var r = Ur(e);
        ...
        function Vr(t, e) {
            ...
            if (!(o(n.staticStyle) && o(n.style) && o(r.staticStyle) && o(r.style))) {
                ...
                var p = function (t, e) {
                    var n, r = {};
                    if (e) for (var o = t; o.componentInstance;) (o = o.componentInstance._vnode) && o.data && (n = Dr(o.data)) && T(r, n);
                    (n = Dr(t.data)) && T(r, n);
        ...
        var Hr = {create: Vr, update: Vr}, Br = /\s+/;
            ...
            if (!o(r) && !i(n._enterCb) && 1 === n.nodeType) {
                ...
                if (!k || w || "" === w) {
                    var S = k && d ? d : u, T = k && v ? v : f, E = k && p ? p : l, j = k && b || m,
                        I = k && "function" == typeof w ? w : y, D = k && C || g, L = k && $ || _,
                        M = h(c(A) ? A.enter : A);
                    0;
                    var N = !1 !== a && !Z, F = vo(I), R = n._enterCb = P(function () {
                        N && (oo(n, E), oo(n, T)), R.cancelled ? (N && oo(n, S), L && L(n)) : D && D(n), n._enterCb = null
                    });
                    t.data.show || se(t, "insert", function () {
                        var e = n.parentNode, r = e && e._pending && e._pending[t.key];
                        r && r.tag === t.tag && r.elm._leaveCb && r.elm._leaveCb(), I && I(n, R)
                    }), j && j(n), N && (ro(n, S), ro(n, T), no(function () {
            ...
            return function (t, e, n, s) {
                if (!o(e)) {
                    ...
                    if (o(t)) l = !0, f(e, d); else {
                        var p = i(t.nodeType);
                        if (!p && or(t, e)) A(t, e, d, null, null, s); else {
                            if (p) {
        ...
        function _o(t, e, n) {
            ...
            if (!o || Array.isArray(r)) {
                for (var i, a, s = 0, c = t.options.length; s < c; s++) if (a = t.options[s], o) i = M(r, wo(a)) > -1, a.selected !== i && (a.selected = i); else if (L(wo(a), r)) return void(t.selectedIndex !== s && (t.selectedIndex = s));
                o || (t.selectedIndex = -1)
            }
        }
        ...
        }, Lo = T({tag: String, moveClass: String}, ko);
        ...
        delete Lo.mode;
        var Fo = {
            Transition: Do, TransitionGroup: {
                props: Lo, beforeMount: function () {
                    ...
                    t.length && this.hasMove(t[0].elm, e) && (t.forEach(Mo), t.forEach(Po), t.forEach(No), this._reflow = document.body.offsetHeight, t.forEach(function (t) {
                        if (t.data.moved) {
        ...
        }, xn.config.isReservedTag = Jn, xn.config.isReservedAttr = Dn, xn.config.getTagNamespace = function (t) {
        ...
        }, T(xn.options.directives, Oo), T(xn.options.components, Fo), xn.prototype.__patch__ = q ? mo : j, xn.prototype.$mount = function (t, e) {
    ...
    var r = n(2), o = function () {
        ...
        return (this._self._c || t)("div", {attrs: {id: "test"}}, [this._v("\n    " + this._s(this.text) + "}\n")])
    };
    o._withStripped = !0;
    var i = {data: () => ({text: "abc"})};
    n(3);
